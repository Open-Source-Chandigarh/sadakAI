...
import { Send, Bot, User, MessageCircle, Settings, HelpCircle } from 'lucide-react';
...
const DesktopChatbot = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <div className="w-64 bg-gray-800 p-4 border-r border-gray-700 overflow-y-auto flex-shrink-0">
